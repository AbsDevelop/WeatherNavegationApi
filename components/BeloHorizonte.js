...
export default function App() {
  ...
  async function buscaCep(){
    const response = await Api.get(`weather?array_limit=10&fields=only_results,temp,city_name,forecast,max,min,date,time,description,city,humidity,wind_speedy%20&key=ca53326e&city_name=BeloHorizonte`);
  ...
  return (
      ...
      <View style={styles.container}>
          <Text style={styles.title}>Meteorologia: Cidade de Belo Horizonte</Text>
